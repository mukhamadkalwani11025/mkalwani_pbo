...
class FrmCelcius:
    ...
    def aturKomponen(self):
        ...
        nama = Label(nametag, text="Mukhamad kalwani", bg='lightblue') 
        nama.grid(row=5, column=0, sticky='e', padx=5, pady=5)

        nim = Label(nametag, text="220511025", bg='lightblue')
        nim.grid(row=5, column=2, sticky="e", padx=5, pady=5)

        kelas = Label(nametag, text="TIF22C", bg='lightblue') 
