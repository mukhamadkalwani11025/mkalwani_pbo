...
# Nama, NIM dan Kelas
nametag = Frame(frame, bg="lightyellow", height=30)
nametag.grid(row=5, column=0, columnspan=3, sticky="ew", pady=10)

nama = Label(nametag, text="Mukhamad Kalwani", bg='lightyellow') 
nama.grid(row=5, column=0, sticky='e', padx=5, pady=5)

nim = Label(nametag, text="220511025", bg='lightyellow')
nim.grid(row=5, column=2, sticky="e", padx=5, pady=5)

kelas = Label(nametag, text="TIF22C", bg='lightyellow')
