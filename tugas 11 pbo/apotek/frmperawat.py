...
class Frmperawat:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Perawat bagian:').grid(row=4, column=0, sticky=W, padx=5, pady=5)
        ...
        Cbo['values'] = ('Mata','Gigi','Anak Kecil')
        Cbo.current()      
        ...
        # define columns
        columns = ('idprwt', 'nip', 'nama','jk','perawat')
        ...
        self.tree.heading('perawat', text='Perawat')
        self.tree.column('perawat', width="100")
        # set tree position
...
if __name__ == '__main__':
    root = tk.Tk()
    aplikasi = Frmperawat(root, "Aplikasi Data Perawat")
    root.mainloop() 